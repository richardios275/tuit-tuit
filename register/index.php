...
<body style="background-color: #8ace93ff;">
  <section class="container-fluid d-flex justify-content-center align-items-center py-4">


    <main class="tuittuit-bg p-4 mb-2 rounded" style="box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.3);">
      <form action="../actions/register_action.php" method="post" class="mx-4">
        <div class="pb-5">
          <img src="/public/svg/logo.svg" alt="Tuit Tuit" height="48" background-color="">
        </div>
        ...
        <div class="mb-2 form-check">
          ...
          <label class="form-check-label" for="agreeCheckBox">By signing up, you agree to the <a target="_blank"
              href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Terms of Service</a> and <a target="_blank"
              href="#" data-bs-toggle="modal" data-bs-target="#privacyModal">Privacy Policy</a></label>
        </div>
