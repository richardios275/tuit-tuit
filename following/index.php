...
$stmt = $pdo->prepare("
    ...
    WHERE posts.user_username IN (
        SELECT following_user_username
        FROM follows
        WHERE followed_user_username = :profile_username
...
<?php $title="Following"; include($_SERVER['DOCUMENT_ROOT'] . '/components/main_header.php'); ?>
